...
char *dst_ip = "192.168.43.111";
char *src_ip = "192.168.43.6";//client ip

// char *src_ip = "192.168.200.173";
// char *dst_ip = "192.168.200.90";//client ip
...
int main(int argc, char *argv[])
{
    ...
    char sour_call[64];
    char dest_call[64];
    memset(sour_call, 0, 64);
    memset(dest_call, 0, 64);
    snprintf(sour_call, 64, "sip:140@%s", src_ip);
    snprintf(dest_call, 64, "sip:133@%s:15060", dst_ip);
    ...
    i = eXosip_listen_addr(context_eXosip, IPPROTO_UDP, src_ip, 15061, AF_INET, 0);
    if(i != 0)
    {
