...
void app_main(void)
{
    ...
    char *source_call="sip:140@192.168.200.90";
    char *dest_call="sip:133@192.168.200.173:15061";
    ...
    i=eXosip_listen_addr(context_eXosip, IPPROTO_UDP, "192.168.200.90",15060,AF_INET,0);
    if(i!=0)
    {
